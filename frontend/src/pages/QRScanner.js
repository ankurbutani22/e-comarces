  ...
  return (
    <div className="scanner-shell">
      ...
      <div className="scanner-video-card">
        ...
        {!cameraReady && !scanPaused ? (
          <div className="scanner-placeholder">
            {error ? 'Camera unavailable' : 'Starting camera...'}
          </div>
        ) : null}
        {scanPaused ? (
          <div className="scanner-placeholder">Scan completed. Camera stopped.</div>
        ) : null}
      </div>
      ...
      <section className="scanner-result-card">
        ...
        {scanResult ? (
          <>
            ...
            <button type="button" onClick={restartScan} disabled={busy}>
              Scan Another QR
            </button>
          </>
        ) : (
